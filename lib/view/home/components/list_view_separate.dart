...
class ListViewSeparate extends StatelessWidget {
  const ListViewSeparate({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.separated(
        ...
        itemBuilder: (context, index) {
          return Container(
            margin: EdgeInsets.symmetric(horizontal: width / 20, vertical: height / 70),
            ...
            child: Row(
              children: [
                Container(
                  decoration: BoxDecoration(color: AppColors.grayColor, borderRadius: BorderRadius.only(bottomLeft: Radius.circular(height / 15), topLeft: Radius.circular(height / 15))),
                  width: width / 6,
                  child: Center(
                    child: Text(
                      (index + 1).toString(),
                ...
                IconButton(
                  ...
                  icon: const Icon(Icons.drive_file_rename_outline, color: AppColors.amberColor),
                ),
                IconButton(
                  splashRadius: 1,
                  onPressed: () {},
